...
def hypothesis_test():
    ...
    plt.figure()
    plt.hist(simulated_stats, bins=15, color="lightblue", edgecolor="black", alpha=0.7, label="Simulated Statistics")
...
def confidence_interval():
    ...
    plt.hlines(0, ci_lower, ci_upper, color="blue", linestyle="-", linewidth=4, label=f"{confidence_level:.1f}% Confidence Interval")
    plt.axvline(true_param, color="green", linestyle="--", linewidth=2, label=f"True Slope")
